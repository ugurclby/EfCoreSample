...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.Customer", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.CustomerWithOrder", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.Order", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.OrderWithDetail", b =>
                {
                    b.Property<DateTime>("OrderDate")
                        .HasColumnType("datetime2");
                    ...
                    b.ToTable("OrderWithDetails");

                    b.ToSqlQuery("SELECT od.OrderDetailId,od.OrderId,o.OrderDate,o.TotalAmount,od.ProductName FROM Orders o inner join OrderDetails od on o.OrderId = od.OrderId");
                });
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.Users", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EfCoreSample.CodeFirst.DAL.VCustomersWithOrders", b =>
                {
                    b.Property<int>("CustomerId")
                        .HasColumnType("int");
                    ...
                    b.ToView("VCustomersWithOrders", (string)null);
                });
